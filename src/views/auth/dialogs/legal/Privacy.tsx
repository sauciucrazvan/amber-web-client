...
export default function PrivacyView({ children }: Props) {
  const { t } = useTranslation();

  const contentText = t("legal.privacy.content").replace(/\\n/g, "\n");
  ...
  const content = (
    <>
      <DialogHeader>
        ...
        <DialogDescription>{t("legal.privacy.description")}</DialogDescription>
      </DialogHeader>
